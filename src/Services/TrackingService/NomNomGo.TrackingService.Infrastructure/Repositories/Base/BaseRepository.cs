...
namespace NomNomGo.TrackingService.Infrastructure.Repositories.Base
{
    /// <summary>
    /// Generic repository implementation for Entity Framework Core
    /// </summary>
    /// <typeparam name="T">Entity type</typeparam>
    public class BaseRepository<T> : Domain.Interfaces.Repositories.Base.IRepository<T> where T : BaseEntity
    {
