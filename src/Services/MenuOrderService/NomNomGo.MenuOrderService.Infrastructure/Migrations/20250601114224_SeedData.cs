    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParsingStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParsingQueues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParsingQueues_ParsingStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "ParsingStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParsingQueues_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemChanges_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActiveDeliveries_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActiveDeliveries_OrderId",
                table: "ActiveDeliveries",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourierLocations_CourierId_RecordedAt",
                table: "CourierLocations",
                columns: new[] { "CourierId", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemChanges_MenuItemId",
                table: "MenuItemChanges",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParsingQueues_RestaurantId",
                table: "ParsingQueues",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_ParsingQueues_StatusId",
                table: "ParsingQueues",
                column: "StatusId");
        }
